...
VALUES 
    (1001, 996036, GETDATE(), 2, 150.00, 1, 2, 1, 0, 'Cold', 'Recovering', 'Take rest and stay hydrated'), 
    (1001, 996036, GETDATE(), 2, 200.00, 0, 2, 1, 0, 'Flu', 'Stable', 'Continue medication'), 
    (1001, 996036, GETDATE(), 2, 175.00, 2, 2, 1, 0, 'Infection', 'Improving', 'Antibiotics for 5 days'), 
    (1001, 996036, GETDATE(), 2, 220.00, 3, 2, 1, 0, 'Headache', 'Relieved', 'Pain reliever as needed');  
...
DECLARE @count INT;
EXEC RetrieveBillHistoryAlt @pID = 996036, @count = @count OUTPUT;
SELECT @count AS 'Count';

-- Inserción de más registros en Appointment
INSERT INTO Appointment (DoctorID, PatientID, Date, Appointment_Status, Bill_Amount, Bill_Status, DoctorNotification, PatientNotification, FeedbackStatus, Disease, Progress, Prescription)
VALUES 
    (1001, 996036, GETDATE(), 3, 150.00, 1, 2, 1, 0, 'Cold', 'Recovering', 'Take rest and stay hydrated'),
    (1001, 996036, DATEADD(day, -7, GETDATE()), 3, 200.00, 1, 2, 1, 0, 'Flu', 'Stable', 'Continue medication');
